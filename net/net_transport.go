...
used to communicate with newdag on remote machines. It requires
...
func (n *NetworkTransport) listen() {
	for {
		...
		n.logger.Log("debug", "accepted connection", LogFields{"node": conn.LocalAddr(), "from": conn.RemoteAddr()})
