...
func NewTCPTransport(bindAddr string, advertise net.Addr, maxPool int, timeout time.Duration, logger *Logger) (*NetworkTransport, error) {
...
func newTCPTransport(bindAddr string, advertise net.Addr, maxPool int, timeout time.Duration,
	...
	// Create stream
	stream := &TCPStreamLayer{advertise: advertise, listener: list.(*net.TCPListener)}
